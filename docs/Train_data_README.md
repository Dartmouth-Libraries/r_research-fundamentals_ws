...
from: <https://github.com/Flightmussy/trainrouter-atlas>
...
🗺️ **Explore it interactively:** [trainrouter.com](https://trainrouter.com) 🤖 **Use it from an AI assistant:** free MCP server at `https://trainrouter.com/mcp` ([how to connect](https://trainrouter.com/mcp-server/)) — or run it from this repo: `npm install && npm start` ([`mcp/`](mcp/))
